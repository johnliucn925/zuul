...
public final class SourceAddressChannelHandler extends ChannelInboundHandlerAdapter {
    ...
    /**
     * Indicates the actual source (remote) port of the channel, if present.  This can be different than the one {@link
     * Channel} returns if the connection is being proxies.  (e.g. over HAProxy).
     *
     * @deprecated use {@link #ATTR_REMOTE_ADDR} instead, and check if it is an {@code InetSocketAddress}.
     */
    @Deprecated
     ...
     */
    @Deprecated
    public static final AttributeKey<String> ATTR_SERVER_LOCAL_ADDRESS = AttributeKey
            .newInstance("_server_local_address");
